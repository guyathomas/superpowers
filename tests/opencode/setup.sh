...
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/workflows/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/workflows/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/workflows/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/workflows.js" "$HOME/.config/opencode/workflows/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/workflows/.opencode/plugins/workflows.js" \
       "$HOME/.config/opencode/plugins/workflows.js"
...
echo "Plugin installed to: $HOME/.config/opencode/workflows/.opencode/plugins/workflows.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/workflows.js"
