...
# IMPORTANT: Run from workflows directory so local dev skills are available
...
if grep -q '"name":"Skill".*"skill":"workflows:subagent-driven-development"' "$SESSION_FILE"; then
