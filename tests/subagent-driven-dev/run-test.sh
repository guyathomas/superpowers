...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/workflows
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/workflows-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using workflows:subagent-driven-development. The plan is at: $PLAN_PATH"
